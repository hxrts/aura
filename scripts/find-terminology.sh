...
add_term "Interior access" "TraversalDepth::Interior|::Interior|\"interior\"|\\binterior (depth|access)\\b" "Context-aware access usage"
add_term "Frontage access" "TraversalDepth::Frontage|::Frontage|\"frontage\"|\\bfrontage (depth|access)\\b" "Context-aware access usage"
add_term "Street access" "TraversalDepth::Street|::Street|\"street\"|\\bstreet(-level| depth| view)\\b" "Context-aware access usage"
...
add_term "Adjacency" "Adjacency|adjacency" "Context-aware topology terminology" "May remain in graph-edge APIs; treat as manual review term."
add_term "TraversalDepth" "TraversalDepth|traversal_depth|TRAVERSAL_DEPTH" "Access-level enum name"
add_term "Donation" "Donation|donation" "Context-sensitive storage terminology" "Manual review required where 'donation' is user-facing copy vs protocol field."
