#!/usr/bin/env bash
# Ratchet check that changed files carry required ownership annotations.
set -euo pipefail
...
check_capability_boundary_completeness() {
  ...
  local -a required_entries=(
    ...
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_home_created_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_account_created_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_channel_membership_ready_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_invitation_created_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_invitation_exported_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_channel_invitation_created_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_invitation_accepted_or_materialized_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_pending_invitation_consumed_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_invitation_declined_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_invitation_revoked_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_device_enrollment_started_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_message_committed_proof"
    "crates/aura-app/src/workflows/semantic_facts/proofs.rs:issue_device_enrollment_imported_proof"
