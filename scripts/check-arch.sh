...
check_effects() {
  ...
  if [[ -n "$parity_clock_filtered" ]]; then
    ...
    hint "Reference: docs/105_effect_system.md (time effects) and docs/805_simulation_guide.md (deterministic simulation constraints)."
  else
  ...
  if [[ -n "$parity_timer_filtered" ]]; then
    ...
    hint "Reference: docs/105_effect_system.md (effect boundary rules), docs/805_simulation_guide.md (no wall-clock in simulation)."
  else
  ...
  if [[ -n "$parity_random_filtered" ]]; then
    ...
    hint "Reference: docs/105_effect_system.md (effect boundaries) and docs/804_testing_guide.md (strict conformance lanes)."
  else
