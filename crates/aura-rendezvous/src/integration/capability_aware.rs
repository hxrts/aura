...
impl SbbRelationship {
    ...
    pub fn new(
        ...
        // Default relay capability based on trust level (legacy - now handled by Biscuit tokens)
...
mod tests {
    ...
    fn test_relationship_forwarding_logic() {
        ...
        let low_trust_rel =
            SbbRelationship::new(peer_id, rel_id.clone(), TrustLevel::Low, false, now);
        let high_trust_rel =
            SbbRelationship::new(peer_id, rel_id.clone(), TrustLevel::High, true, now);
