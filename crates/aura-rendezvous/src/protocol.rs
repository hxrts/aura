...
pub mod guards {
    use crate::capabilities::{RelayCapability, RendezvousCapability};
    ...
    pub fn rendezvous_publish_capability() -> aura_core::CapabilityName {
        RendezvousCapability::Publish.as_name()
    }

    pub fn rendezvous_connect_capability() -> aura_core::CapabilityName {
        RendezvousCapability::Connect.as_name()
    }

    pub fn rendezvous_relay_capability() -> aura_core::CapabilityName {
        RendezvousCapability::Relay.as_name()
    }

    pub fn relay_forward_capability() -> aura_core::CapabilityName {
        RelayCapability::Forward.as_name()
    }
}
...
pub mod exchange_runners {
    pub use super::exchange::telltale_session_types_rendezvous::rendezvous::runners::{
        execute_as, run_initiator, run_responder, InitiatorOutput, ResponderOutput,
    };
    pub use super::exchange::telltale_session_types_rendezvous::rendezvous::RendezvousExchangeRole;
}

/// Re-exports for RelayedRendezvous choreography runners
pub mod relayed_runners {
    pub use super::relayed::telltale_session_types_rendezvous_relay::rendezvous_relay::runners::{
        execute_as, run_initiator, run_relay, run_responder, InitiatorOutput, RelayOutput,
        ResponderOutput,
    };
    pub use super::relayed::telltale_session_types_rendezvous_relay::rendezvous_relay::RelayedRendezvousRole;
}
...
mod tests {
    ...
    fn test_guard_constants() {
        ...
        assert_eq!(
            guards::rendezvous_publish_capability().as_str(),
            "rendezvous:publish"
        );
    }
