...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerFactory, DefaultHandlerFactory};
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerBuilder, AuraHandlerConfig, ExecutionMode, EffectType};
//! use aura_core::DeviceId;
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerBuilder, SimulationConfig, ExecutionMode};
//! use aura_core::DeviceId;
//! use std::time::Duration;
//!
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerBuilder, MiddlewareConfig};
//! use aura_core::DeviceId;
//! use std::time::Duration;
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::AuraHandlerBuilder;
//! use aura_core::DeviceId;
//! use std::collections::HashMap;
//!
//! let device_id = DeviceId::generate();
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{PlatformDetector, AuraHandlerBuilder};
//! use aura_core::DeviceId;
//!
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerConfig, PlatformConfig};
//! use aura_core::DeviceId;
//!
//! let device_id = DeviceId::generate();
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{AuraHandlerConfig, FactoryError};
//! use aura_core::DeviceId;
//!
//! let device_id = DeviceId::generate();
//! let mut config = AuraHandlerConfig::for_production(device_id);
...
//!
//! ```rust,no_run
//! use aura_protocol::coordinators::factory::{DefaultHandlerFactory, FactoryError, EffectType};
//! use aura_core::DeviceId;
//!
//! let device_id = DeviceId::generate();
...
use crate::coordinators::{EffectType, ExecutionMode};
...
///
/// ```rust,no_run
/// use aura_protocol::coordinators::factory::{AuraHandlerFactory, AuraHandlerConfig, FactoryError};
/// use aura_protocol::coordinators::erased::BoxedHandler;
...
// This maintains the architectural boundary and avoids direct async filesystem usage outside effects layer
