...
pub struct DkdProtocolResult {
    ...
    /// Derived public key
    pub derived_public_key: Ed25519VerifyingKey,
...
mod tests {
    ...
    // TODO: Re-enable this test once test helpers are available for ThresholdCapability and VerificationContext
    // #[test]
    // fn test_dkd_commit_payload() {
    //     // Test disabled - requires test helpers for ThresholdCapability and VerificationContext
    // }
}
