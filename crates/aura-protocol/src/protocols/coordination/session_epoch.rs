...
impl SessionEpochMonitor {
    pub fn new(participants: Vec<BridgedRole>, check_interval: Duration) -> Self {
        Self {
            participants,
            check_interval,
        }
    ...
    pub async fn monitor<H: ChoreoHandler<Role = BridgedRole>>(
        &self,
        handler: &mut H,
...
impl EpochBumpChoreography {
    pub fn new(participants: Vec<BridgedRole>, required_confirmations: usize) -> Self {
        Self {
            participants,
    ...
    pub async fn bump_epoch<H: ChoreoHandler<Role = BridgedRole>>(
        &self,
        handler: &mut H,
        endpoint: &mut H::Endpoint,
        my_role: BridgedRole,
