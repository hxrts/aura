        ...
        match config.execution_mode {
            ExecutionMode::Testing => {
                use aura_effects::{
                    ...
                    journal::MemoryJournalHandler, network::MockNetworkHandler,
                    random::MockRandomHandler, storage::MemoryStorageHandler,
                ...
                builder = builder
                    .with_handler(
                        EffectType::Crypto,
                        Arc::new(CryptoHandlerAdapter::new(MockCryptoHandler::new(42), mode)),
                    )
                    .with_handler(
                        EffectType::Network,
                        Arc::new(NetworkHandlerAdapter::new(MockNetworkHandler::new(), mode)),
                    )
                    .with_handler(
                        EffectType::Storage,
                    ...
                    .with_handler(
                        EffectType::Random,
                        Arc::new(RandomHandlerAdapter::new(MockRandomHandler::new(0), mode)),
                    )
                    .with_handler(
                        EffectType::Journal,
            ...
            ExecutionMode::Production => {
                use aura_effects::{
                    ...
                    storage::{filesystem::SecureStorageConfig, FilesystemStorageHandler},
                ...
                builder = builder
                    ...
                    .with_handler(
                        EffectType::Network,
                        Arc::new(NetworkHandlerAdapter::new(TcpNetworkHandler::new(), mode)),
                    )
                    .with_handler(
                        EffectType::Storage,
                        Arc::new(StorageHandlerAdapter::new(
                            FilesystemStorageHandler::with_config(
                                config.storage_config.base_path.clone(),
                                SecureStorageConfig {
                                    master_key: config.storage_config.master_key,
