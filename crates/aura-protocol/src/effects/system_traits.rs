...
//! that were previously part of the legacy system.rs implementation.
//! These have been extracted to allow removal of the deadlock-prone AuraEffectSystem
//! while preserving the trait interface.
