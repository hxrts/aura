...
mod tests {
    ...
    fn test_causal_context_empty() {
        ...
        assert!(ctx.logical_time.vector.is_empty());
    ...
    fn test_causal_context_happens_before() {
        ...
        ctx1.logical_time.vector.insert(device_b, 0);

        let mut ctx2 = CausalContext::empty();
        ctx2.logical_time.vector.insert(device_a, 2);
        ctx2.logical_time.vector.insert(device_b, 0);
    ...
    fn test_causal_context_concurrent() {
        ...
        let mut ctx2 = CausalContext::empty();
        ctx2.logical_time.vector.insert(device_a, 0);
        ctx2.logical_time.vector.insert(device_b, 1);
    ...
    fn test_causal_context_merge() {
        ...
        ctx1.logical_time.vector.insert(device_b, 1);
