...
impl ConnectionInfo {
    ...
    pub fn new_at_time(peer_id: DeviceId, privacy_level: PrivacyLevel, started_at: SystemTime) -> Self {
    ...
    pub fn new_scoped(
        ...
        Self::new_scoped_at_time(peer_id, relationship_id, privacy_level, SystemTime::UNIX_EPOCH)
    }
    ...
    pub fn establish_at_time(&mut self, privacy_context: PrivacyContext, established_at: SystemTime) {
