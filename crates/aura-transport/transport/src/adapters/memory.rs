// Memory transport adapter for testing
//
...
/// Memory transport adapter - in-memory only
///
...
// Implementation of coordination's Transport trait for MemoryTransport
...
fn generate_test_signature() -> ed25519_dalek::Signature {
    ...
    let message = b"test_message_for_memory_transport";
