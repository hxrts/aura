...
pub use vm_hardening::{
    ...
    policy_for_protocol, policy_for_ref, scheduler_control_input_for_image,
    ...
    AuraVmProtocolExecutionPolicy, AuraVmSchedulerControlInput, AuraVmSchedulerExecutionPolicy,
