//! Logical clock manager (Layer 6 runtime-owned state).
//!
...
#[async_trait]
impl LogicalClockEffects for LogicalClockManager {
...
mod tests {
    ...
    async fn test_logical_clock_monotonicity() {
        let service = LogicalClockManager::new(None);
