...
struct OtaOrchestratorRef {
    ...
    cache_invalidation: std::sync::Arc<Mutex<Option<CacheInvalidationSystem>>>,
    execution_lock: std::sync::Arc<Mutex<()>>,
    epoch_fences: std::sync::Arc<RwLock<HashMap<String, u64>>>,
}
