...
use aura_relational::{
    CONTACT_FACT_TYPE_ID, FRIENDSHIP_FACT_TYPE_ID, GUARDIAN_BINDING_DETAILS_FACT_TYPE_ID,
...
pub static FACT_TYPE_IDS: Lazy<Vec<&'static str>> = Lazy::new(|| {
    vec![
        ...
        WOT_FACT_TYPE_ID.as_str(),
        VERIFY_FACT_TYPE_ID.as_str(),
        MAINTENANCE_FACT_TYPE_ID.as_str(),
        STORAGE_FACT_TYPE_ID.as_str(),
        TRANSPORT_FACT_TYPE_ID.as_str(),
    ]
});
