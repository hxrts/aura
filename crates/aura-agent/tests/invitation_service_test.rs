    ...
    T: Send + 'static,
{
    std::thread::Builder::new()
        .name("invitation-service-test-large-stack".to_string())
...
#[test]
fn test_invitation_service_via_agent() -> TestResult {
...
#[test]
fn test_invite_as_contact_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_invite_as_guardian_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_invite_to_channel_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_invite_to_channel_rejects_invalid_home_id() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_decline_invitation_via_agent_succeeds_despite_followup_failure() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_cancel_invitation_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_list_pending_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
...
#[test]
fn test_get_invitation_via_agent() -> TestResult {
    run_async_test_on_large_stack(async move {
