...
const CONTACTS_BINDINGS: &[KeyBinding] = &[
    ...
    KeyBinding::new("a", "a", "Accept", "Accept invite code", "Contacts", true),
    KeyBinding::new("n", "n", "Invite", "Create invite code", "Contacts", true),
    KeyBinding::new("i", "i", "Invite", "Create invite code", "Contacts", true),
    KeyBinding::new(
        "I",
        "I",
        "Channel Invite",
