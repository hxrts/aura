...
pub fn frost_verifying_key_to_dalek(
    frost_key: &frost::VerifyingKey,
) -> Result<VerifyingKey> {
...
pub fn dalek_verifying_key_to_frost(
    dalek_key: &VerifyingKey,
) -> Result<frost::VerifyingKey> {
...
mod tests {
    ...
    fn setup_frost_keys(
        ...
        if threshold != num_participants {
            panic!("FROST v1.0 requires threshold ({}) == num_participants ({})", threshold, num_participants);
        }
    ...
    fn test_frost_threshold_signature_3_of_3() {
        ...
        let share1 = FrostSigner::sign_share_with_package(
            message,
            &nonces1,
            &all_commitments,
            key1,
        ...
        let share2 = FrostSigner::sign_share_with_package(
            message,
            &nonces2,
            &all_commitments,
            key2,
        ...
        let share3 = FrostSigner::sign_share_with_package(
            message,
            &nonces3,
            &all_commitments,
            key3,
    ...
    fn test_frost_signature_invalid_message_fails() {
        ...
        assert!(result.is_err(), "Signature verification should fail for wrong message");
    }
