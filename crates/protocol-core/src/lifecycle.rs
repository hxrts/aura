...
use crate::capabilities::ProtocolEffects;
use crate::metadata::{OperationType, ProtocolMode, ProtocolPriority, ProtocolType};
use crate::typestate::{SessionState, SessionStateTransition};
...
pub enum ProtocolInput<'a> {
    ...
    Message(&'a crate::capabilities::ProtocolMessage),
...
pub trait ProtocolLifecycle: Send + Sync {
    ...
    fn step(
        ...
        caps: &mut crate::capabilities::ProtocolCapabilities<'_>,
