...
use app_console_types::{BranchInfo, ConsoleCommand, SimulationInfo, TraceEvent};
...
mod tests {
    ...
    fn test_event_recording() {
        ...
        let test_event = TraceEvent {
            tick: 0,
            event_id: 1,
            event_type: app_console_types::EventType::EffectExecuted {
                effect_type: "test".to_string(),
                effect_data: vec![],
            },
            participant: "test_participant".to_string(),
            causality: app_console_types::CausalityInfo {
                parent_events: vec![],
                happens_before: vec![],
                concurrent_with: vec![],
            },
