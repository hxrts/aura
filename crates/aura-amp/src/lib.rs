...
pub mod amp_runners {
    pub use crate::choreography::telltale_session_types_amp_transport::amp_transport::runners::{
        execute_as, run_receiver, run_sender, ReceiverOutput, SenderOutput,
    };
    pub use crate::choreography::telltale_session_types_amp_transport::amp_transport::AmpTransportRole;
}
