//! Protocol types for coordination and threshold cryptography
//!
//! This module contains types specifically used by the protocol coordination layer
//! for threshold cryptography, participant management, and session coordination.
