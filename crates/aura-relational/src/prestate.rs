//! Prestate computation for consensus operations
//!
//! This module handles the computation of prestate hashes that bind
//! consensus operations to specific states of the participating authorities.
