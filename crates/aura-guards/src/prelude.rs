...
pub use crate::guards::chain::{
    create_send_guard, create_send_guard_op, SendGuardChain, SendGuardResult,
};
...
pub trait GuardsEffects:
    GuardEffects + GuardContextProvider + aura_core::effects::time::PhysicalTimeEffects
{
}
