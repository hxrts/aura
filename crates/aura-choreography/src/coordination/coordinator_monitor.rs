...
impl CoordinatorMonitor {
    ...
    pub async fn monitor_coordinator<H: ChoreoHandler<Role = ChoreographicRole>>(
        &self,
        handler: &mut H,
    ...
    async fn send_heartbeats<H: ChoreoHandler<Role = ChoreographicRole>>(
        &self,
        handler: &mut H,
        endpoint: &mut H::Endpoint,
        my_role: ChoreographicRole,
    ...
    async fn receive_heartbeats<H: ChoreoHandler<Role = ChoreographicRole>>(
        &self,
        handler: &mut H,
        endpoint: &mut H::Endpoint,
        my_role: ChoreographicRole,
    ...
    pub async fn report_coordinator_failure<H: ChoreoHandler<Role = ChoreographicRole>>(
        &self,
        handler: &mut H,
        endpoint: &mut H::Endpoint,
        my_role: ChoreographicRole,
        failed_coordinator: ChoreographicRole,
    ) -> Result<bool, ChoreographyError> {
