//! KeyFabric node rotation choreography using choreographic patterns
//!
...
/// KeyFabric node rotation choreography using patterns
pub struct KeyFabricNodeRotationChoreography {
    config: NodeRotationConfig,
    effects: Effects,
}

impl KeyFabricNodeRotationChoreography {
    ...
    pub async fn execute<H: ChoreoHandler<Role = ChoreographicRole>>(
        ...
        tracing::info!(
            ...
            "Starting KeyFabric node rotation choreography"
        );
        ...
        tracing::info!(
            ...
            "KeyFabric node rotation completed"
        );
...
/// Convenience function for KeyFabric node rotation
pub async fn keyfabric_rotate_node<H: ChoreoHandler<Role = ChoreographicRole>>(
    handler: &mut H,
    endpoint: &mut H::Endpoint,
    participants: Vec<ChoreographicRole>,
    my_role: ChoreographicRole,
    ...
    let choreography = KeyFabricNodeRotationChoreography::new(config, effects);
    choreography
