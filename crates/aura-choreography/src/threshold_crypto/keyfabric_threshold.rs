//! KeyFabric threshold unwrapping choreography using choreographic patterns
//!
...
/// KeyFabric threshold unwrapping choreography using patterns
pub struct KeyFabricThresholdChoreography {
    config: ThresholdUnwrapConfig,
    effects: Effects,
}

impl KeyFabricThresholdChoreography {
    ...
    pub async fn execute<H: ChoreoHandler<Role = ChoreographicRole>>(
        ...
        tracing::info!(
            ...
            "Starting KeyFabric threshold unwrapping choreography"
        );
        ...
        tracing::info!(
            ...
            "KeyFabric threshold unwrapping completed successfully"
        );
...
/// Convenience function for KeyFabric threshold unwrapping
pub async fn keyfabric_threshold_unwrap<H: ChoreoHandler<Role = ChoreographicRole>>(
    handler: &mut H,
    endpoint: &mut H::Endpoint,
    participants: Vec<ChoreographicRole>,
    my_role: ChoreographicRole,
    ...
    let choreography = KeyFabricThresholdChoreography::new(config, effects);
    choreography
