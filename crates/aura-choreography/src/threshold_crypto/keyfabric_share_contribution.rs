//! KeyFabric share contribution choreography using choreographic patterns
//!
...
/// KeyFabric share contribution choreography using patterns
pub struct KeyFabricShareContributionChoreography {
    config: ShareContributionConfig,
    effects: Effects,
}

impl KeyFabricShareContributionChoreography {
    ...
    pub async fn execute<H: ChoreoHandler<Role = ChoreographicRole>>(
        ...
        tracing::info!(
            ...
            "Starting KeyFabric share contribution choreography"
        );
        ...
        tracing::info!(
            ...
            "KeyFabric share contribution completed successfully"
        );
...
/// Convenience function for KeyFabric share contribution
pub async fn keyfabric_collect_shares<H: ChoreoHandler<Role = ChoreographicRole>>(
    handler: &mut H,
    endpoint: &mut H::Endpoint,
    participants: Vec<ChoreographicRole>,
    my_role: ChoreographicRole,
    ...
    let choreography = KeyFabricShareContributionChoreography::new(config, effects);
    choreography
