...
mod tests {
    ...
    use crate::protocols::choreographic::{
        ...
        ChoreographicRole, BridgedEndpoint, RumpsteakAdapter,
    };
    ...
    async fn test_tracing_middleware_with_choreography() {
        ...
        // Create roles
        let role1 = ChoreographicRole { device_id: device_id.into(), role_index: 0 };
        let role2 = ChoreographicRole { device_id: Uuid::new_v4(), role_index: 1 };
