...
use super::{BridgedEndpoint, ChoreographicRole};
    ...
    H::DeviceId: From<Uuid> + Into<Uuid>,
{
    ...
    pub fn current(&self, _ep: &mut BridgedEndpoint) -> ChoreographicRole {
        ChoreographicRole {
            device_id: self.context.device_id,
            role_index: 0, // TODO: Get actual role index
        }
