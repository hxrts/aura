...
use app_console_types::{SimulationTrace, TraceEvent};
...
mod tests {
    use super::*;
    use app_console_types::{CausalityInfo, EventType, TraceMetadata};
    ...
    fn create_test_trace() -> SimulationTrace {
        ...
        SimulationTrace {
            ...
            network_topology: app_console_types::NetworkTopology {
