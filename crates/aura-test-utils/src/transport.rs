...
use aura_types::{AuraResult, DeviceId};
...
///
/// This provides a simplified transport interface that test code can use
#[async_trait]
...
pub fn test_transport_stack(device_id: DeviceId) -> TransportMiddlewareStack {
    ...
    impl TransportHandler for TestTransportHandler {
        fn execute(
            ...
            _effects: &dyn aura_protocol::effects::AuraEffects,
