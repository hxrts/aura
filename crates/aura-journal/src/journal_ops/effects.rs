//! KeyJournal Effects Trait for External Dependency Injection
//!
//! This module defines the effects trait for KeyJournal operations, following the
...
/// Effects trait for KeyJournal operations
/// 
/// This trait abstracts all external dependencies needed by KeyJournal:
...
/// Production implementation of JournalEffects
pub struct JournalEffectsAdapter {
    device_id: DeviceId,
    biscuit_keypair: BiscuitKeyPair,
}

impl JournalEffectsAdapter {
...
#[async_trait]
impl JournalEffects for JournalEffectsAdapter {
    /// Automerge CRDT Operations
...
mod tests {
    ...
    #[tokio::test]
    async fn test_journal_effects_creation() {
        let device_id = DeviceId::new_v4();
        let effects = JournalEffectsAdapter::new(device_id);
