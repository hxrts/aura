...
pub struct AccountState {
    ...
    // ===== Storage State =====
    /// Storage metadata for managed blobs
    /// Map: Cid -> StorageMetadata
    pub storage_metadata: BTreeMap<aura_types::Cid, StorageMetadata>,
    /// Storage usage tracking per device
    /// Map: DeviceId -> StorageQuota
    pub storage_quotas: BTreeMap<DeviceId, StorageQuota>,
    /// Access audit log for compliance
    pub access_audit_log: Vec<AccessAuditEntry>,
}
...
impl AccountState {
    ...
    pub fn new(
        ...
        AccountState {
            ...
            storage_metadata: BTreeMap::new(),
            storage_quotas: BTreeMap::new(),
            access_audit_log: Vec::new(),
        }
    }
