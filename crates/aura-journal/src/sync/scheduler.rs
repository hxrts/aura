...
use super::PeerInfo;
use super::{DeviceId, OpLogSynchronizer, PeerSyncManager, SyncError, SyncResult};
...
mod tests {
    use super::*;
    use crate::semilattice::op_log::OpLog;
    ...
    fn test_scheduler_creation() {
        ...
        let device_id = crate::DeviceId(uuid::Uuid::from_bytes([0u8; 16]));
