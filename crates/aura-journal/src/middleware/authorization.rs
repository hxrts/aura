...
use aura_types::{CanonicalPermission, DeviceId};
...
impl AuthorizationMiddleware {
    ...
    pub fn new(checker: Box<dyn PermissionChecker>, config: AuthorizationConfig) -> Self {
        Self { checker, config }
    }
    ...
    fn process(
        ...
        if !has_permission {
            return Err(Error::invalid_operation(format!(
                ...
                context.device_id, required_permission, operation
            )));
        }
...
mod tests {
    ...
    fn test_authorization_middleware_allows_permitted_operation() {
        ...
        let middleware =
            AuthorizationMiddleware::new(Box::new(checker), AuthorizationConfig::default());
    ...
    fn test_admin_permission_allows_all_operations() {
        ...
        let operation = JournalOperation::AddDevice {
            device: DeviceMetadata {
                ...
                public_key: aura_crypto::Ed25519VerifyingKey::from_bytes(
