...
fn tree_commitment_root_fixtures() {
    ...
    assert_eq!(
        ...
        [
            0xE1, 0x49, 0xBD, 0x5E, 0x2F, 0x73, 0x1F, 0x0F, 0xCD, 0xF7, 0xA7, 0x02, 0x63, 0x51,
            0x98, 0xA0, 0x76, 0x13, 0x56, 0xD8, 0xF9, 0x08, 0x56, 0x69, 0xEA, 0x14, 0x39, 0xFE,
            0x79, 0x0B, 0x31, 0xAB
        ]
    );
    assert_eq!(
        root_after_epoch,
        [
            0x59, 0x4D, 0x19, 0x69, 0xCE, 0x75, 0x6E, 0x9C, 0x28, 0x9A, 0x99, 0xA8, 0x77, 0x23,
            0x0D, 0x1D, 0xF6, 0x0B, 0xC6, 0x90, 0x11, 0x70, 0xA8, 0x05, 0x7B, 0x54, 0x4A, 0xD7,
            0x21, 0x40, 0xA0, 0x18
        ]
    );
    assert_eq!(
        ...
        [
            0x07, 0x0F, 0x9D, 0x88, 0x5A, 0xDB, 0xC3, 0x54, 0x3A, 0x6D, 0x9C, 0xDC, 0xCA, 0xE0,
            0x2C, 0xE1, 0x84, 0x10, 0x1C, 0x65, 0xD5, 0x2A, 0x68, 0x59, 0xAD, 0xFC, 0xB6, 0xE4,
            0x11, 0xDE, 0x3F, 0xD8
        ]
    );
}
