...
pub mod recovery_runners {
    ...
    pub use crate::recovery_protocol::telltale_session_types_recovery_protocol::recovery_protocol::runners::{
...
pub mod ceremony_runners {
    pub use crate::guardian_ceremony::telltale_session_types_guardian_ceremony::guardian_ceremony::GuardianCeremonyRole;
    pub use crate::guardian_ceremony::telltale_session_types_guardian_ceremony::guardian_ceremony::runners::{
        execute_as, run_guardian1, run_guardian2, run_initiator,
        Guardian1Output, Guardian2Output, InitiatorOutput,
    };
    // Re-export generated message wrapper types for adapter construction
    // Note: These types are generated by the choreography macro. They're newtype wrappers
    // around the payload types (e.g., ProposeRotation wraps CeremonyProposal).
    // Access them via the message_wrappers module which is specifically designed for external use.
    pub use crate::guardian_ceremony::telltale_session_types_guardian_ceremony::message_wrappers::{
        AbortCeremony, CommitCeremony, ProposeRotation, RespondCeremony,
    };
}

/// Re-exports for GuardianSetup choreography runners
pub mod setup_runners {
    pub use crate::guardian_setup::telltale_session_types_guardian_setup::guardian_setup::GuardianSetupRole;
    pub use crate::guardian_setup::telltale_session_types_guardian_setup::guardian_setup::runners::{
...
pub mod membership_runners {
    pub use crate::guardian_membership::telltale_session_types_guardian_membership_change::guardian_membership_change::GuardianMembershipChangeRole;
    pub use crate::guardian_membership::telltale_session_types_guardian_membership_change::guardian_membership_change::runners::{
