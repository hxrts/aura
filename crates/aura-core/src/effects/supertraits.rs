...
where 
    T: NetworkEffects + CryptoEffects + TimeEffects + ConsoleEffects,
{}
...
where 
    T: StorageEffects + JournalEffects + ConsoleEffects,
{}
...
pub trait AntiEntropyEffects: NetworkEffects + CryptoEffects + RandomEffects + ConsoleEffects {
    // Sealed trait - users cannot implement this directly
}
...
where 
    T: CryptoEffects + RandomEffects + ConsoleEffects,
{}
