...
fn convert_topology_to_network_data(
    topology: &aura_console_types::NetworkTopology,
    ...
    for (node_id, node_info) in &topology.nodes {
        let node_type = match node_info.participant_type {
            aura_console_types::trace::ParticipantType::Honest => NodeType::Honest,
            aura_console_types::trace::ParticipantType::Byzantine => NodeType::Byzantine,
            aura_console_types::trace::ParticipantType::Offline => NodeType::Observer,
        };

        let status = match node_info.status {
            aura_console_types::trace::ParticipantStatus::Online => NodeStatus::Online,
            aura_console_types::trace::ParticipantStatus::Offline => NodeStatus::Offline,
            aura_console_types::trace::ParticipantStatus::Partitioned => NodeStatus::Error,
        };
