...
fn invitation_is_channel_style_pending(invitation: &crate::views::invitations::Invitation) -> bool {
...
fn invitation_is_channel_style(invitation: &crate::views::invitations::Invitation) -> bool {
