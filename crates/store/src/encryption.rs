...
impl EncryptionContext {
    ...
    pub fn encrypt(&self, plaintext: &[u8]) -> crate::Result<Vec<u8>> {
        ...
        let ciphertext = self
            ...
            .map_err(|_| crate::StorageError::Storage("Encryption failed".to_string()))?;
    ...
    pub fn decrypt(&self, data: &[u8]) -> crate::Result<Vec<u8>> {
        if data.len() < 12 {
            return Err(crate::StorageError::Storage("Invalid ciphertext".to_string()));
        }
        ...
        self.cipher
            ...
            .map_err(|_| crate::StorageError::Storage("Decryption failed".to_string()))
    }
