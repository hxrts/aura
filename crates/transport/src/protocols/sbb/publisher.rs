...
impl SbbPublisher {
    ...
    pub fn encrypt_payload(
        ...
        let ciphertext = cipher
            ...
            .map_err(|e| TransportErrorBuilder::transport(format!("encryption failed: {}", e)))?;
    ...
    pub fn decrypt_payload(
        ...
        ciphertext: &[u8],
        nonce: &[u8; 24],
    ) -> TransportResult<EnvelopePayload> {
        use chacha20poly1305::aead::{Aead, Nonce};
        ...
        let plaintext = cipher
            ...
            .map_err(|e| TransportErrorBuilder::transport(format!("decryption failed: {}", e)))?;
    ...
    pub fn publish_envelope(
        ...
        published_at: u64,
    ) -> TransportResult<PublishedEnvelope> {
        ...
        let envelope_bytes = envelope.to_bytes().map_err(|e| {
            TransportErrorBuilder::transport(format!("envelope serialization failed: {}", e))
        })?;
