...
impl<'a, E: RelationshipFormationEffects> RelationshipFormationCoordinator<'a, E> {
    ...
    async fn execute_as_initiator(
        ...
        let timestamp = self
            ...
            .await
            .map_err(|e| {
                RelationshipFormationError::Core(aura_core::AuraError::internal(format!(
                    "Time error: {}",
                    e
                )))
            })?
...
pub async fn derive_context_id<E: RelationshipFormationEffects>(
    ...
    #[allow(clippy::unwrap_used)] // Array slice of known size never fails
...
pub async fn create_trust_record<E: RelationshipFormationEffects>(
    ...
    record.extend_from_slice(&timestamp.ts_ms.to_le_bytes());
            ...
            Ok(result) => {
                ...
                let timestamp =
                    self.effects
                        ...
                        .await
                        .map_err(|e| {
                            RelationshipFormationError::Core(aura_core::AuraError::internal(
                                format!("Time error: {}", e),
                            ))
                        })?
                        .ts_ms;
...
mod tests {
    ...
    #[tokio::test]
    async fn test_mock_effects_basic_operations() -> Result<(), RelationshipFormationError> {
