...
impl MockCapability {
    ...
    pub fn delegate(
        ...
        let capability_id = Self::generate_capability_id(&Some(parent_id.clone()), &subject_id, &scope);
...
mod tests {
    ...
    fn test_mock_group_provider() {
        ...
        let device1 = DeviceId::new("device1".to_string());
        let device2 = DeviceId::new("device2".to_string());
