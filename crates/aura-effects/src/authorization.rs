...
aura_effect_handlers! {
    ...
    real: {
        ...
        methods: {
            verify_capability(_capabilities: &Cap, operation: &str, _resource: &str) -> Result<bool, AuthorizationError> => {
            ...
            delegate_capabilities(_source_capabilities: &Cap, requested_capabilities: &Cap, _target_device: &DeviceId) -> Result<Cap, AuthorizationError> => {
