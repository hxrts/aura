...
//!
//! ```rust
//! use aura_errors::{AuraError, Result, ErrorCode, ErrorSeverity};
//!
    ...
    pub fn context(&self) -> &ErrorContext {
        match self {
            Self::Protocol(e) => match e {
                ...
                | ProtocolError::Orchestrator { context, .. } => context,
            },
            ...
            Self::Infrastructure(e) => match e {
                ...
                | InfrastructureError::TransportAuthenticationFailed { context, .. } => context,
            },
            ...
            Self::Capability(e) => match e {
                ...
                | CapabilityError::VerificationFailed { context, .. } => context,
            },
