...
- [x] 7) Split `aura-protocol` into sub-crates (`aura-guards`, `aura-consensus`, `aura-amp`, `aura-bridge`, `aura-anti-entropy`) with clean public APIs
- [x] 8) Move generic anti-entropy orchestration from `aura-protocol::sync` into new `aura-anti-entropy` crate; update dependencies and tests
