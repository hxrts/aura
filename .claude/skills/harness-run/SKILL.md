...
- shared scenarios stay on the canonical semantic actor-based contract; legacy scripted fixtures remain explicitly quarantined
- new policy should extend typed validator domains first, with `scripts/check/` kept as thin workflow wrappers
