...
Aura Consensus is not linearizable by default. Each consensus instance independently agrees on a single operation and prestate. To sequence operations, use session types (see [MPST and Choreography](110_mpst_and_choreography.md)).
...
See [Operation Categories](109_operation_categories.md) for full details on these types and their usage.
...
- [Journal System](105_journal.md) - Fact storage, reduction, and flow budgets
- [Operation Categories](109_operation_categories.md) - Agreement, propagation, acknowledgment, and ceremony contract
- [Authorization](106_authorization.md) - Biscuit token evaluation
- [Effect System](103_effect_system.md) - Effect implementation patterns
