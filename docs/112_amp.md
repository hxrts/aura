...
AMP integrates with Aura's unified consistency metadata system for delivery tracking. For UI presentation of delivery status indicators, see [CLI and TUI](117_cli_tui.md#message-status-indicators). For consistency type definitions, see [Operation Categories](109_operation_categories.md).
...
- [CLI and TUI](117_cli_tui.md) for UI delivery status display
