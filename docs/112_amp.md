...
Older checkpoints dominated by newer ones are pruned. Proposed bumps superseded by committed bumps are pruned. Normal Aura snapshot garbage collection applies.
