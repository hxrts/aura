...
Delivery acknowledgments leak timing metadata. Applications should batch acknowledgments to reduce timing precision. Read receipts should default to disabled. High-sensitivity contexts can disable acks entirely. See [Operation Categories](109_operation_categories.md) for consistency type definitions and [CLI and TUI](117_user_interface.md#message-status-indicators) for status indicators.
