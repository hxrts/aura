...
AMP integrates with Aura's unified consistency metadata system for delivery tracking. For UI presentation of delivery status indicators, see [CLI and TUI](116_cli_tui.md#message-status-indicators). For consistency type definitions, see [Operation Categories](107_operation_categories.md).
