...
Aura aims to demonstrate that web-of-trust architectures can be practical and user-aligned.
...
These three pillars combine into an 8-layer architecture from interface definitions through user-facing applications. See [System Architecture](002_system_architecture.md) for the complete layer breakdown, [Theoretical Model](001_theoretical_model.md) for mathematical foundations, and [Project Structure](999_project_structure.md) for dependency details.
...
| Core Systems | [Peer Discovery System](104_rendezvous_system) | Peer discovery and connection setup specification |
...
| Reference | [Effects API](500_effects_api.md) | Effect system interfaces and handler patterns reference |
...
| Reference | [Access Control API](503_access_control_api.md) | Access control patterns and capabilities reference |
