...
";
      ...
      "caching" = rec {
        ...
        src = lib.cleanSourceWith {
          filter = sourceFilter;
          src = ./ext/rumpsteak-aura/caching;
        };
        authors = [
          "Sam Hart"
        ];
      ...
      "native-tls" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target =
              { target, features }:
              (!(("windows" == target."os" or null) || ("apple" == target."vendor" or null)));
          }
          {
            name = "openssl";
            packageId = "openssl";
...
";
      ...
      "path+file:///Users/hxrts/projects/aura/ext/rumpsteak-aura/choreography#rumpsteak-aura-choreography@0.3.1" =
        rec {
          ...
          src = lib.cleanSourceWith {
            filter = sourceFilter;
            src = ./ext/rumpsteak-aura/choreography;
          };
      ...
      "path+file:///Users/hxrts/projects/aura/ext/rumpsteak-aura/macros#rumpsteak-aura-macros@0.3.1" =
        rec {
      ...
      "wasm-bindgen-test" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target =
              { target, features }:
              (("wasm32" == target."arch" or null) && (target."wasm_bindgen_unstable_test_coverage" or false));
          }
          {
            name = "wasm-bindgen";
            packageId = "wasm-bindgen";
